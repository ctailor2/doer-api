...
public class TodoCompleted implements DomainEvent {
    ...
    TodoCompleted(UserId userId, ListId listId, CompletedTodoId completedTodoId, String task, Date completedAt) {
        this.userId = userId;
        this.listId = listId;
